...
#define TEXTURE_GAME_RESULT00	_T("data/TEXTURE/result.png")	// リザルト00用画像
#define TEXTURE_RESULT00_SIZE_X	(500 * SCREEN_SCALING/2) // テクスチャサイズ
#define TEXTURE_RESULT00_SIZE_Y	(200 * SCREEN_SCALING/2) // 同上
#define RESULT_POS_X			(SCREEN_CENTER_X)	// 初期座標X
#define RESULT_POS_Y			(130 * SCREEN_SCALING)	// 初期座標Y
...
#define RESULT_MOVE_UI				(250 * SCREEN_SCALING)	// リザルト時の他UI移動
