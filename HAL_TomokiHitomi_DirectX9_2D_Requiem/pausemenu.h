...
#define TEXTURE_PAUSEMENU00_SIZE_X	(400 * SCREEN_SCALING/2) // テクスチャサイズ
#define TEXTURE_PAUSEMENU00_SIZE_Y	(80 * SCREEN_SCALING/2) // 同上

#define PAUSEMENU_POS_X			(SCREEN_CENTER_X)	// 初期座標X
#define PAUSEMENU_POS_Y			(380 * SCREEN_SCALING)				// 初期座標Y
#define PAUSEMENU_SPACING		(80 * SCREEN_SCALING)

#define TEXTURE_PATTERN_DIVIDE_X_PAUSEMENU	(1)	// アニメパターンのテクスチャ内分割数（X)
#define TEXTURE_PATTERN_DIVIDE_Y_PAUSEMENU	(6)	// アニメパターンのテクスチャ内分割数（Y)
