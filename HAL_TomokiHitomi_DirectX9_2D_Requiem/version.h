...
#define TEXTURE_GAME_VERSION	_T("data/TEXTURE/version.png")	// VERSION用画像
#define TEXTURE_VERSION_SIZE_X	(180 * SCREEN_SCALING/2) // テクスチャサイズ
#define TEXTURE_VERSION_SIZE_Y	(30 * SCREEN_SCALING/2) // 同上

#define VERSION_POS_X				(1100 * SCREEN_SCALING)			// 初期座標X
#define VERSION_POS_Y				(693 * SCREEN_SCALING)			// 初期座標Y
