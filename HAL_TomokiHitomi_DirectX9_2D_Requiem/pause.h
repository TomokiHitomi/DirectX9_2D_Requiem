...
#define TEXTURE_PAUSE00_SIZE_X	(450 * SCREEN_SCALING/2) // テクスチャサイズ
#define TEXTURE_PAUSE00_SIZE_Y	(180 * SCREEN_SCALING/2) // 同上
#define PAUSE_POS_X			(SCREEN_CENTER_X)	// 初期座標X
#define PAUSE_POS_Y			(250 * SCREEN_SCALING)				// 初期座標Y
